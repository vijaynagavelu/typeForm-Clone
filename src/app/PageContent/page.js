        ...
        <main className={`${contentClasses}`}>
            ...
            <div className={`flex flex-col text-left`}>
                ...
                <div className="bg-transparent border-b-2 border-slate-200 pb-2">
                    <input type="email" ref={inputRef} autoFocus={1 === 1} className="text-2xl font-light focus:outline-none appearance-none bg-transparent" onChange={(e) => { setInput(e.target.value), setError(false) }} value={input} placeholder="Type your answer here..." />
                </div>
                {!error && <div onClick={() => { handleLoadNextPage() }} className={`mt-4 flex flex-col items-center text-lg cursor-pointer font-semibold pb-4`}>
                    <div className='flex text-base mb-4 group rounded-lg border border-transparent px-2.5 py-2 transition-colors bg-gray-100 bg-opacity-10  hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800 hover:drk:bg-opacity-30'>
                        <span >OK {' '}</span>
            ...
            <main className={`${contentClasses} flex grow-0 flex-col justify-center `}>
                ...
                <div className={`flex flex-col text-left`}>
                    ...
                    <div className="z-[51] bg-black flex justify-between items-center border-b-2 border-slate-200 pb-2">
                        <input type="email" ref={inputRef} autoFocus={1 === 1} className="text-xl font-light focus:outline-none appearance-none bg-transparent" onChange={(e) => { setInput(e.target.value), setError(false) }} value={input} placeholder="Select an option..." />
                    ...
                    {!error && <div className={`${showDropdown ? 'text-transparent hidden' : 'opacity-0 animate-dropdown-in'} mt-4 flex flex-col items-start text-lg cursor-pointer font-semibold pb-4`}>
                        <div className={` ${showDropdown ? 'bg-transparent' : ''} flex text-base mb-4 group rounded-lg border border-transparent px-2.5 py-2 transition-colors bg-gray-100 bg-opacity-10  hover: border-gray-300 hover: bg-gray-100 hover: dark: border-neutral-700 hover: dark: bg-neutral-800 hover: drk: bg-opacity-30`}>
                            <span >OK {' '}</span>
                            <span className="inline-block pl-2 transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
                                ✓
                            </span>
                        ...
                        {options.map((option, i) => {
                            return (
                                <div key={i}
                                    ...
                                    <div className={`blinking-button ${(blinking && input === option) ? 'blink' : ''} flex  justify-between rounded-md  px-2.5 py-2 transition-colors bg-gray-200 bg-opacity-10   hover:bg-gray-800  `}>
                                        <span> {option} </span>
            ...
            <main className={`${contentClasses} flex`}>
                ...
                <div className={`flex flex-col  text-left`}>
                    ...
                    {options.map((option, i) => {
                        return (
                            <div key={i}
                                ...
                                <div className={`blinking-button ${(blinking && input === option) ? 'blink' : ''} flex mb-2 justify-between rounded  px-2.5 py-2 transition-colors bg-gray-200 bg-opacity-10   hover:bg-gray-800 `}>
                    ...
                    {!error && <div className={`mt-4 flex flex-col items-start text-lg cursor-pointer font-semibold pb-4`}>
                        <div className='flex mb-4 text-base group rounded-lg border border-transparent px-2.5 py-2 transition-colors bg-gray-100 bg-opacity-10  hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800 hover:drk:bg-opacity-30'>
                            <span >OK {' '}</span>
                            <span className="inline-block pl-2 transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
                                ✓
                            </span>
        ...
        <main className={`${contentClasses}`}>
            ...
            <div className={`flex flex-col text-left`}>
                ...
                {!error && <div onClick={() => { lastPage ? handleSubmit() : handleLoadNextPage() }} className={`mt-8 flex flex-col items-start text-lg cursor-pointer font-semibold pb-4`}>
                    <div className={`flex  ${lastPage ? 'w-full justify-center' : ''} ${submit ? 'hidden' : ''}  text-base mb-4 group rounded-lg border border-transparent px-2.5 py-2 transition-colors bg-gray-100 bg-opacity-10  hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800 hover:drk:bg-opacity-30`}>
